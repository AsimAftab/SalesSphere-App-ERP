...
@override
String toString() {
  return 'AuthUser(id: $id, email: $email, fullName: $fullName, phone: $phone, organizationId: $organizationId, roleId: $roleId, avatarUrl: $avatarUrl)';
}
...
class _AuthUser implements AuthUser {
  const _AuthUser({required this.id, required this.email, required this.fullName, this.phone, this.organizationId, this.roleId, this.avatarUrl});
