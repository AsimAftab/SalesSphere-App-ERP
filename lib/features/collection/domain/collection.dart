...
///
/// Unlike Collection Plus, this is a plain on-account receipt: the money
/// is collected against the *party* as a whole, not booked against any
/// specific invoice. The bank / cheque fields are only populated when
/// [paymentMode] calls for them ([PaymentModeX.requiresBank] /
