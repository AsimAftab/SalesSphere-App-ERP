/// What kind of entity a visit note is linked to. Exactly one of
/// these is set on every note (the "linked to one party / prospect /
/// site" requirement from the form).
enum VisitNoteLinkType {
  party,
  prospect,
  site,
}

/// UI-facing visit-note model. Decoupled from wire DTOs so backend
/// renames don't ripple into widgets. Will be promoted to freezed
/// once the visit-notes API + drift table land.
///
...
class VisitNote {
  ...
  final VisitNoteLinkType linkType;
  final String linkId;
