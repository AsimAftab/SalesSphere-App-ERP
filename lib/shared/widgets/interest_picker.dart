...
/// The bottom sheet. Two steps: category → brands. Holds its own
/// working copy of the catalogue so adding categories or brands stays
/// reactive without round-tripping through the parent.
