...
/// One entry in a [PrimaryFilterBar]'s dropdown. The generic [T] is the
...
/// [FilterBarOption]s on tap. The bar's body shows the currently
...
class PrimaryFilterBar<T> extends StatefulWidget {
  ...
  final List<FilterBarOption<T>> options;
  ...
  @override
  State<PrimaryFilterBar<T>> createState() => _PrimaryFilterBarState<T>();
}

class _PrimaryFilterBarState<T> extends State<PrimaryFilterBar<T>> {
  ...
  Future<void> _open() async {
    ...
    final picked = await showMenu<FilterBarOption<T>>(
      context: context,
      position: position,
      ...
      items: widget.options
          .map(
            (o) => PopupMenuItem<FilterBarOption<T>>(
              value: o,
...
class _OptionRow<T> extends StatelessWidget {
  ...
  final FilterBarOption<T> option;
